...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert Potsdam annotations to TrainIds')
    parser.add_argument('--vaihingen-path', default='data/vaihingen', help='vaihingen data path')
...
def main():
    args = parse_args()
    vaihingen_path = args.vaihingen_path
    out_dir = args.out_dir if args.out_dir else vaihingen_path
    mmcv.mkdir_or_exist(out_dir)

    gt_dir = osp.join(vaihingen_path, args.gt_dir)
