...
def parse_args():
    ...
    parser.add_argument('--potsdam-path', default='data/potsdam', help='potsdam data path')
...
def main():
    args = parse_args()
    potsdam_path = args.potsdam_path
    out_dir = args.out_dir if args.out_dir else potsdam_path
    mmcv.mkdir_or_exist(out_dir)

    gt_dir = osp.join(potsdam_path, args.gt_dir)
