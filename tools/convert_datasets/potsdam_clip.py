...
def main():
    ...
    mmcv.mkdir_or_exist(osp.join(out_dir, 'ann_dir', 'train_color'))
    mmcv.mkdir_or_exist(osp.join(out_dir, 'ann_dir', 'val_color'))
        ...
        with tempfile.TemporaryDirectory(dir=args.tmp_dir) as tmp_dir:
            ...
            for i, src_path in enumerate(src_path_list):
                ...
                if 'label' in src_path:
                    ...
                    dst_dir = osp.join(out_dir, 'ann_dir', data_type+'_color')
